...
What makes it different: it's a **progressive ladder**. Instead of one monolithic template you have to reverse-engineer, mahusay is published as eight tagged tiers — from a bare Next.js boilerplate up to full RBAC, an installable PWA, and optional Firebase services. Check out the tier that matches your needs, or walk them in order to *learn* how each layer is built. See the [Version Ladder](#-version-ladder).
...
| <img src="https://api.iconify.design/lucide/flame.svg?color=%236366f1" width="18" height="18" alt=""> **Optional Firebase** | Opt-in Analytics, FCM, Remote Config & Performance — all env-toggled |
...
| [`v7.0.0`](https://github.com/anthony-celeres/mahusay/tree/v7.0.0) | Progressive Web App — installable + offline | — |
| **[`v8.0.0`](https://github.com/anthony-celeres/mahusay/tree/v8.0.0)** | **Optional Firebase services (Analytics, FCM, Remote Config, Performance)** *(= `main`)* | `firebase` |
